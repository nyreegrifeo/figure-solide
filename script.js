...
document.getElementById("replayBtn").addEventListener("click", () => {
  const current = document.getElementById("shapeSelect").value;
  createShape(current);
});
...
document.getElementById("playRotBtn").addEventListener("click", () => {
